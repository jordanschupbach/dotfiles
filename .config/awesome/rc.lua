...
home_fs_usage=blingbling.value_text_box({height = 18, width = 65, v_margin = 4})
...
home_fs_usage:set_rounded_size(0.6)
home_fs_usage:set_font_size(9)
...
cal_box = wibox({height = 200, width = 240, ontop = true, x = 100, y = 100})
...
cal_box.visible = false
 ...
 -- task_w:set_task_done_icon("home/jordan/.config/awesome/test/titlebar/awesome.png")
...
---------------------------------
-- taskwarrior tasklist widget
---------------------------------

-- add_tasklist()

-- TODO set a key to toggle the tasklist
-- awful.key({ }, "#111", function () toggle_tasklist() end),
-- }}} Task Warrior widget
...
for s = 1, screen.count() do
	...
	cpu_graph,
	home_fs_usage,netwidget,cal,task_w,
}

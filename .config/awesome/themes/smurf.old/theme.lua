...
theme.font                                      = "UbuntuMono Nerd Font Mono 13"
...
-- theme.layout_centerwork.horizontal              = theme.dir .. "/icons/centerworkh.png"
...
-- Battery
local activateBatbar = false; -- true - activates batbar (laptop)
                              -- flase - disable batbar (desktop)
if activateBarbar then
...
theme.fs = lain.widget.fs({
    partition = "/home",  -- Use this if /home is on a seperate partition
    -- partition = "/",        -- Use this if using only one partition for system install
